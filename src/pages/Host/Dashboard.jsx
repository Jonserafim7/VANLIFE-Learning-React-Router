        ...
        <div className='px-8 pb-14 flex flex-col'>  
            <section className='mx-[-32px]'>
                <div className='bg-[#FFEAD0] px-8 py-4 flex flex-col gap-3'>
                    ...
                    <div className='flex'>
                        <h2>Income last <span className='underline'>30 days</span></h2>
                ...
                <div className='bg-[#FFDDB2] px-8 py-4 flex'>
                    <div className='flex items-center'>
                        ...
                        <img src='/src/Assets/Icons/Star-3.png' className='ml-3' alt='star' />
                        <h3 className='font-bold ml-1'>5.0/<span className='font-normal'>5</span></h3>
                    </div>
                    <button className='ml-auto'>Details</button>
                </div>
            </section>
